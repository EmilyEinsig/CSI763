...
title('Magnetic Field Magnitude for 08 November 2012 - Stationary 1');
...
xlabel('Time');
ylabel('B Magnitude (nT)');
title('Magnetic Field Magnitude for 08 November 2012 - Stationary 2');
...
title('Magnetic Field Magnitude for 08 November 2012 - Stationary 3');
...
xlabel('Time');
ylabel('B Magnitude (nT)');
title('Magnetic Field Magnitude for 08 November 2012 - Stationary 4');
...
xlabel('Time');
ylabel('B Magnitude (nT)');
title('Magnetic Field Magnitude for 08 November 2012 - Stationary 5');
